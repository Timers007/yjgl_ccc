(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined'
		...
		? define(factory)
		: ((global = global || self),
		  ((global.CesiumNavigation = global.CesiumNavigation || {}), (global.CesiumNavigation.umd = factory())));
})(this, function () {
	'use strict';
	...
	var distances = [
		1, 2, 3, 5, 10, 20, 30, 50, 100, 200, 300, 500, 1000, 2000, 3000, 5000, 10000, 20000, 30000, 50000, 100000,
		200000, 300000, 500000, 1000000, 2000000, 3000000, 5000000, 10000000, 20000000, 30000000, 50000000,
	];
	...
	function rotate(viewModel, compassElement, cursorVector) {
		...
		if (
			!sscc.enableLook &&
			(scene.mode === SceneMode$2.COLUMBUS_VIEW || (scene.mode === SceneMode$2.SCENE3D && !sscc.enableRotate))
		) {
			return;
		} // Remove existing event handlers, if any.
	...
	function initialize(viewerCesiumWidget, options) {
		...
		if (
			(!defined$7(this.terria.options.enableZoomControls) || this.terria.options.enableZoomControls) &&
